...
export default function JoinGamePage({ changePage }: JoinGamePageProps) {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-8">
      <h2 className="text-4xl font-bold mb-6">Rejoindre une Partie</h2>
...
function GameList({
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
      <h2 className="text-2xl font-semibold mb-4">Parties disponibles</h2>
